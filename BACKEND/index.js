...
app.use(
  cors({
    origin: [
      "https://zerodha-clone-1-vnqf.onrender.com",
...
app.post("/sellOrder", async (req, res) => {
    ...
    // Find all BUY orders for this stock
    ...
    return res.status(400).json({
        message: "You have not bought this stock."
    });
}
    ...
    // Find all SELL orders for this stock
    ...
    // Remaining quantity
    let availableQty = boughtQty - soldQty;

    // Check if user can sell
    if (req.body.qty > availableQty) {
        return res.status(400).json({
